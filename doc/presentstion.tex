...
\frame{\frametitle{btrfs - Einleitung}
	\begin{outline}
		...
		\2 basiert auf \enquote{B-trees, shadowing, and clones} by Ohad Rodeh \cite{rodeh2008b}
...
\frame{\frametitle{btrfs - Struktur}
	\only<1>{
		\begin{figure}
		\includegraphics[width=.8\textwidth, height=.7\textheight]{img/btrfs-design.jpg}
	\end{figure}
}
\only<2>{
	\begin{figure}
		\includegraphics[width=.8\textwidth, height=.7\textheight]{img/btrfs-tree.png}
	\end{figure}
}}
...
\frame{\frametitle{btrfs - RAID}
	\centering
	Traditionelles RAID 0\\
	\begin{figure}[h!]
		\centering    
		\movie[label=show3loop] {}{img/raid0.mp4}
		\caption{caption}
	\end{figure} 
}
...
\frame{\frametitle{btrfs - Weitere Features}
	\begin{outline}
		...
		\2 \emph{btrfs subvolume create <name>}
		}
	}
	\end{outline}
}
